...
public class UIGrid : LayoutGroup
{
    ...
    [SerializeField]
    protected int m_constraintCount = 1;
    [SerializeField]
    ...
    [SerializeField]
    protected List<GameObject> m_headStaticObjList = new List<GameObject>();
    [SerializeField]
    protected List<GameObject> m_tailStaticObjList = new List<GameObject>();
    [SerializeField]
    protected bool m_isStaticInRule = true;
    [SerializeField]
    private AutoCollectStaticType m_autoCollectType = AutoCollectStaticType.Head;
    [SerializeField]
    protected EmptyFillType m_emptyFillType = EmptyFillType.None;
    [SerializeField]
    protected GameObject m_emptyCell;
    [SerializeField]
    protected int m_emptyCellCapacity;
    [SerializeField]
    protected int m_lazyCount = 1;
    [SerializeField]
    protected bool m_disableScrollWhenLessCell = false;
    [SerializeField]
    protected List<GameObject> m_ignoreList = new List<GameObject>();
    [SerializeField]
    protected SelectType m_selectType = SelectType.None;
    [SerializeField]
    protected bool m_allowSelectSameAgain = false;
    [SerializeField]
    protected int m_selectLimitedCount = 0;
